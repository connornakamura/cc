...
function setup() {
  ...
  img1 = loadImage("aaron.jpg");  // Load the image
...
stroke(255,255,255);
textSize(30);
text("Important People",windowWidth/2 - windowWidth/7, 700);
...
if (200 < val) {
  ...
  text("testing 123 testing 123 testing 123 testing 123", xpos, 1250, xpos + 100, 1500); // Text wraps within text box
...
function law() {
  ...
  xpos1 = xpos1 + 5;
  // if the circle moves off screen, reset it's position
  if(xpos1 > windowWidth/1.6)
  {
    xpos1 = windowWidth/1.6;
  }
  fill(255,0,0);
  image(img1, xpos1, 650);
  textSize(20);
  text("Aaron Swartz",xpos1, 1200);

  text("testing 123 testing 123 testing 123 testing 123", xpos1, 1250, xpos1 + 100, 1500); // Text wraps within text box)
}
